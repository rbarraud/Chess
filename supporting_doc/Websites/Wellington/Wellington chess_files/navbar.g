...
<!-- base href="https://www.blogger.com/navbar.g?targetBlogID=3271378337887562667&blogName=Wellington+chess&publishMode=PUBLISH_MODE_BLOGSPOT&navbarType=LIGHT&layoutType=LAYOUTS&searchRoot=//wellingtonchess2012.blogspot.com/search&blogLocale=en_GB&v=2&homepageUrl=http://wellingtonchess2012.blogspot.com/&vt=-1293706398239965115&usegapi=1&jsh=m%3B%2F_%2Fscs%2Fapps-static%2F_%2Fjs%2Fk%3Doz.gapi.en_GB.jZP4KwfWTDU.O%2Fm%3D__features__%2Fam%3DAQ%2Frt%3Dj%2Fd%3D1%2Ft%3Dzcms%2Frs%3DAGLTcCOKQ3rum35Kog6sSccqiw7h7RGu7A" --></head>
<body class="lang_en">

<div id="b-navbar"><div id="b-navbar-bg" style="z-index:-1"></div>
<div id="b-navbar-fg">
<table id="b-navbar-controls" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr style="height:20px"><td valign="middle" width="24px"><a href="https://www.blogger.com/" id="b-navbar-logo" tabindex="1" title="Go to Blogger.com"></a>
<div id="b-sms" class="b-mobile"><a href="sms:?body=Hi,+take+a+look+at+Wellington+chess+at+http://wellingtonchess2012.blogspot.com/%3Fspref%3Dsms" tabindex="2">Send As SMS</a></div></td>
<td valign="middle" width="150px"><form id="searchthis" action="//wellingtonchess2012.blogspot.com/search" method="get" style="display:inline;"><div id="b-query-box"><table cellpadding="0" cellspacing="0"><tbody><tr><td valign="middle"><input id="b-query" name="q" tabindex="3" style="width: 120px" title="Search" type="text"></td>
<td style="width:15px" valign="middle"><a id="b-query-icon" onclick='document.getElementById("searchthis").submit();' title="Search this blog"></a></td></tr></tbody></table></div>
</form></td>
<td class="gplus" valign="middle" nowrap="nowrap"><div id="___plusone_0" style="text-indent: 0px; margin: 0px; padding: 0px; background: transparent none repeat scroll 0% 0%; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 90px; height: 20px;"><iframe title="+1" data-gapiattached="true" src="navbar_data/fastbutton." name="I0_1442977501937" id="I0_1442977501937" vspace="0" tabindex="0" style="position: static; top: 0px; width: 90px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 20px;" scrolling="no" marginwidth="0" marginheight="0" hspace="0" frameborder="0" width="100%"></iframe></div>


<a id="b-more" class="b-link" tabindex="4" onclick="var anchor = this; if (anchor.__m) { anchor.__m.restyle({show: true}); } else if (!this.__mi) { this.__mi = true; gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() { gapi.iframes.getContext().open( { url: &quot;navbar-more.g?data\x3dAPq4FmAt05xrb5HSDo1vv0B9lXBEB6YcgSHiv_CCGY8wwpkoTGGWezAOsn5GpAon5xYenWW8zVnwb3zxr5SqFzP7Mw507cD3se7kWz3eTGYP4IKDNVgPCsbvEnCXVBakJoeQLwp3yYDCOijj26xz78RZE55i7Xpd-CutAZiQgWAwYHdlRDQ-B-YW2zGGQwbnEXWgsZrv90jL-VcueGHzUkeSv_4aSdD-nX81rJBw4T1NUwySavUcKPMu3WEoB9zeFrURML2TzX4b&quot;, id: 'more-iframe', style: 'bubble', bubbletype: 'pls-default', arrowPosition: 'center', anchorPosition: 'center', anchor: 'b-more', height: 122, width: 250, closeClickDetection: true, hideClickDetection: true, relayOpen: -1 }, function(iframe) { anchor.__m = iframe; } ); }); } return false;">More
<span class="arrow"></span></a>
<a class="b-link" href="https://www.blogger.com/next-blog?navBar=true&amp;blogID=3271378337887562667" id="b-next" tabindex="7">Next Blog»</a></td>
...
<script async="" src="navbar_data/cbgapi.loaded_0"></script><script gapi_processed="true" src="navbar_data/platformgapi.js" async="" type="text/javascript"></script><script type="text/javascript">
